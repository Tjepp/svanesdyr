      ...
      <>
        ...
        {sent ? (
          <MessageSentContainer>
            <Text>{`Jeg afholder i øjeblikket juleferie! Tak for din besked ${name}, jeg er tilbage på kontoret igen den 2. januar 2026. Du får svar hurtigst muligt herefter.`}</Text>
