      ...
      <>
        ...
        {sent ? (
          <MessageSentContainer>
            <Text>{`Jeg afholder i øjeblikket ferie! Tak for din besked ${name}, jeg er tilbage på kontoret igen den 2. september. Du får svar hurtigst muligt herefter.`}</Text>
