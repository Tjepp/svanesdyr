    ...
    <Background>
      <Row>
        <Column widthPercentage="100%">
          ...
          <TextCenter>Ved du hvordan god og jævnbyrdig leg ser ud mellem to hunde?</TextCenter>
          <TextCenter>
            Få svar på hvad du skal kigge efter, når Dyreadfærdskonsulent Sabrina Svane går LIVE og
            fortæller, hvordan du sikrer dig at begge parter i legen stadig synes det er sjovt.
          </TextCenter>
        </Column>
      </Row>
      ...
      <ButtonOnline
        ...
        onClick={() => window.open('https://ezme.io/c/x1S/flCv', '_blank')}
      ></ButtonOnline>
      ...
      <Row marginTop="25px">
        <Column widthPercentage="100%">
          ...
          <TextCenter>
            Hvis du overlader hundene til sig selv, så opstår der meget ofte en situation hvor
            grænserne ikke respekteres. Der bliver simpelthen ikke lyttet. Når din hund ikke føler
            sig lyttet til vil den begynde at råbe højere. Adfærden eskalerer. I sidste ende kan du
            stå med en hund der udviser angst eller aggression, pga. de dårlige oplevelser med andre
            hunde.
          </TextCenter>
          <TextCenter>
            ...
            en voksen, ansvarlig til stede, som kan afbryde når nok er nok og sørge for alle har en
            god stund sammen.
          </TextCenter>
          <TextCenter>Det er her du som ansvarlig hundeejer kommer ind i billedet.</TextCenter>
        </Column>
      </Row>
        ...
        <Column widthPercentage="80%">
          ...
          <FlexedRow>
            ...
            <TextContainer>
              ...
              <Text>
                Jeg er indehaver af Svanes Dyr, hvor jeg arbejder fuldtid som adfærdskonsulent,
                afholder kursusforløb og holdtræning for hunde i alle aldre og inviteres jævnligt ud
                til at holde foredrag om hunde, især med fokus på hundens sprog.
              </Text>
              <Text>
                Jeg driver Hundesprogsklubben på Facebook, da min største passion er at formidle min
                viden om hundens signaler og kropssprog ud til andre passionerede hundeejere. Udover
                at gøre dette online, afholder jeg også socialiseringshold og legestuer, med
                kontrolleret leg i fokus, hvor ejerne udelukkende lære at aflæse deres hunde. Så du
                kan roligt kalde mig fuldblodsnørd i hundesprog og signalforståelse.
              </Text>
            </TextContainer>
          </FlexedRow>
        </Column>
      ...
      <Row marginTop="25px">
        <Column widthPercentage="100%">
          ...
          <TextCenter>
            ...
            information uden at du får konkrete værktøjer til netop hundenes leg og interaktion med
            hinanden.
          </TextCenter>
        </Column>
      </Row>
