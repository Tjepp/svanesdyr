    ...
    <Background>
      <Row marginTop="25px">
        <Column widthPercentage="100%">
          ...
          <Text>En konsultation varer typisk mellem 1 - 1,5 time.</Text>
          <Text>
            <b> + Kørsel</b>
            <br />
            Efter statens takster 3,94 kr/km begge veje ved besøg i hjemmet.
            <br />
          ...
          <Text>
            ...
            <br />
            Dette inkluderer også telefonsamtaler eller mail korrespondance inden besøget (som
            normaltvist takseres).
            <br />
          ...
          <Text>
            ...
            Fri opfølgning på telefon eller mail i 6 mdr.
            <br />
            Dette inkluderer også telefonsamtaler eller mail korrespondance inden konsultationen
            (som normaltvist takseres).
            <br />
            Skriftlig opsummering på tiltag tilsendes på mail efter konsultation.
          </Text>
          ...
          <Text>
            Det er selvfølgelig gratis at ringe og spørge om din problemstilling er noget jeg kan
            hjælpe med eller hvis du ønsker at høre hvad jeg kan tilbyde.
          </Text>
          <Title text="Skriftlig konsultation" />
          <Text>
            Alle spørgsmål velkommen. Gode råd og tiltag gives gerne pr. mail eller facebook
            beskeder, hvis der ikke er behov for konsultation.
            <br />
            ...
            <br />
            <i>
              Ved booking af konsultation takseres der ikke for pågældende mail-samtale eller
              facebook-samtale.
            </i>
          </Text>
          <Text>
            Det er selvfølgelig gratis at skrive og spørge om din problemstilling er noget jeg kan
            hjælpe med eller hvis du ønsker at høre hvad jeg kan tilbyde.
          </Text>
          <Title text="Afbud til konsultation" />
          <TitleColor text="Skal meldes senest 24 timer før aftalt tidspunkt!" />
          <Text>
            Ved for sent afbud afregnes gebyr på 50 % af den afsatte konsultationstid. Ved forgæves
            kørsel afregnes kørselstillæg efter statens takster.
            <br />
          </Text>
          <Title text="Foredrag og Webinar" />
          <Text>Der takseres efter foredragets planlagte varighed.</Text>
          <Text>
            Hverdage man-fre:
            <b> 1.550,- kr./time</b>
            <br />
          ...
          <Text>
            <b> + Kørsel</b>
            <br />
            Efter statens takster 3,94 kr/km begge veje.
            <br />
