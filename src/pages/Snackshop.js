...
const Allergy = ['Lam', 'Kanin', 'Hest'];

const Snacks = ['Buffalo', 'Okse', 'Ged', 'Hjort og Rådyr', 'Vildsvin', 'Gris', 'Kamel', 'Kylling'];
    ...
    <Background>
      <Row>
        <Column widthPercentage="100%">
          ...
          <Text>
            ...
            <br />
            Du finder over 85 forskellige typer af snacks, hvor du blandt udvalget sagtens kan finde
            tyggesager der er:
            ...
            Snackposerne kommer desuden med tydelig EU-mærkat og markering, så du kan se hvor i
          ...
          <TitleCenter text="Snackshoppens næste åbningsdag er: Påske-fredag den 3. april 2026 fra kl. 12.00 - 17.00" />
        </Column>
      </Row>
      ...
      <Row>
        <Column widthPercentage="100%">
          <TitleCenter
            color="#872f35"
            text="Siden her er under opbygning og vil i fremtiden vise Snackshoppens udvalg."
          />
