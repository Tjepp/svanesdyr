    ...
    <Background>
      <Row>
        <Column widthPercentage="100%">
          <Image src={OnlineCoverCatScratch} alt="Coverbillede for e-bog om kattekradsetræning" priority />
          <br />
          <TitleCenter text="Wooohoooo! Det lykkedes!" />
          <TextCenter>
            Tusind tak for din investering i din kat og din tiltro til mig!
            <br />
          </TextCenter>
        </Column>
      </Row>
...
export default OnlineEbookCatThanks;
